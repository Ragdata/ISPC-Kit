...
{ echo "CREATE USER '${DEFAULTS[ADMIN_USER]}'@'${DEFAULTS[ADMIN_IP]}' IDENTIFIED BY '${DEFAULTS_ADMIN_PASSWORD}';"; echo "GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost' IDENTIFIED BY '${DEFAULTS_ADMIN_PASSWORD}' WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;"; } >> "$SQL"
